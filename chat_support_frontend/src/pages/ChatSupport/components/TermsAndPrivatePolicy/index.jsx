...
export const TermsAndPrivatePolicy = forwardRef((props, ref) => (
  <Grid container direction="column" gap={2} sx={{ fontFamily:"Roboto", fontSize: "14px", lineHeight:"18px" }}>
    <Grid item sx={{ marginTop:"-10px", fontWeight: "bold" }}>
    ...
    <Grid item sx={{marginTop:"-10px", textAlign: "justify"}}>
      ...
      profiling and loyalty points, promotional games, release of prizes and such other allied services.
    </Grid>

    <Grid item sx={{marginTop:"-10px", textAlign: "justify"}}>
      In processing your personal information our company adheres to a strict privacy policy in accordance with Republic 
      Act No. 10173 or the Data Privacy Act of 2012.
    </Grid>

    <Grid item sx={{marginTop:"-5px", textAlign: "justify"}}>
      <ol type="1" style={{padding:"3px 0 3px 15px",margin:"5px 0 5px 0"}}>
        <li>
    ...
    <Grid item sx={{marginTop:"-5px", textAlign: "justify"}}>
      <ol type="1" style={{padding:"3px 0 3px 15px",margin:"5px 0 5px 0"}}>
        ...
        <li>
          ...
          <ol type="a" style={{padding:"3px 0 3px 15px",margin:"5px 0 5px 0"}}>
            <li>
              The User acknowledges that non-compliance with AML laws and regulations may result in legal penalties and could lead to the suspension, termination, or restriction of their account on the Platform.
            </li>
          </ol>
        </li>
        <li>
    ...
    <Grid ref={ref} >
      ...
      <Grid item container direction="column" sx={{ marginTop: "8px", textAlign: "justify" }}>
        <Typography sx={{ fontSize: "14px" }}>
          We collect information to provide and improve our services. The types of information we collect include:
        </Typography>
        <ol style={{ listStyleType: "none", padding: "3px 0 3px 15px", margin: "5px 0" }}>
          <li>
            ...
            <ul>
              ...
              <li>Payment information (e.g., Gcash, Maya, Credit/Debit card details)</li>
              <li>Account username and password Identification Card</li>
              <li>Selfie picture</li>
              <li>Updated picture</li>
            </ul>
      </Grid>
      <Grid item sx={{ marginTop:"10px", textAlign: "justify"}}>
        <ol style={{ listStyleType: "none", padding: "3px 0 3px 15px", margin: "5px 0" }}>
          ...
          <li>
            ...
            <ul>
              ...
              <li>Pages visited, time spent on the Platform, and other usage metrics</li>
              <li>Game statistics (e.g., achievements, scores, in-game activity).</li> 
            </ul>
      </Grid>
      <Grid item sx={{ marginTop:"10px", textAlign: "justify"}}>
        <ol style={{ listStyleType: "none", padding: "3px 0 3px 15px", margin: "5px 0" }}> 
          <li>
            ...
            <ul>
              ...
              <li>You can control the use of cookies through your browser settings, but disabling cookies may affect your ability to use certain features of the Platform.</li>                
            </ul> 
      </Grid>
      <Grid item sx={{ marginTop:"10px", textAlign: "justify" }}>
      ...
      <Grid item sx={{ marginTop:"10px", textAlign: "justify" }}>
        <ul>
          ...
          <li>Personalize your experience (e.g., suggesting games or features based on preferences).</li>
          <li>Communicate with you, including sending updates, promotions, and support-related messages.</li>
          <li>Improve the quality and performance of the Platform.</li>
          <li>Detect, prevent, and address technical issues, fraud, or security breaches.</li>
